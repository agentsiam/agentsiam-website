...
export const th: Dictionary = {
  ...
  ownerBandSub: "เป็นเมนูบริการ ไม่ใช่ขั้นตอนตายตัว เลือกเฉพาะบริการที่บ้านของท่านต้องการ ส่วนที่ไม่จำเป็นไม่ต้องเลือก และเราจะบอกเองว่าอะไรจำเป็นสำหรับท่าน",
  ownerBandFoot: "บ้านเดี่ยว ทาวน์โฮม และอาคารขนาดเล็กในเชียงใหม่ รวมถึงคอนโดที่นิติบุคคลอนุญาตให้ปล่อยเช่าระยะสั้นเป็นลายลักษณ์อักษร",
  checkQualify: "เช็กว่าบ้านของท่านเข้าเกณฑ์หรือไม่",
  bookStudy: "จองบริการศึกษาความเป็นไปได้",
  step: "ขั้นที่",
  service: "บริการ",
  stair1Title: "การศึกษาความเป็นไปได้",
  stair1Body: "ประมาณการรายได้ของบ้านท่านโดยเทียบกับอัตราการเข้าพักจริงในย่าน เหมาะกับบ้านที่ยังไม่มีข้อมูลการเข้าพักให้ดู",
  ...
  stair3Body: "ตั้งแต่ลงประกาศและกำหนดราคา ไปจนถึงดูแลผู้เข้าพักและซ่อมบำรุง ดำเนินการโดยทีมในพื้นที่ ไม่ได้บริหารผ่านระบบเพียงอย่างเดียว เจ้าของบ้านส่วนใหญ่เริ่มจากบริการนี้",

  closingGuest: "ยังหาที่พักอยู่ไหม",
  closingOwner: "กำลังคิดจะปล่อยเช่าบ้านอยู่ไหม",

  ownerHeroEyebrow: "สำหรับเจ้าของบ้าน · เชียงใหม่",
  ownerHeroTitle: "เลือกเฉพาะส่วนที่ท่านต้องการ ส่วนที่ไม่ต้องการไม่ต้องเลือก",
  ownerHeroSub: "หกบริการ เลือกตามบ้านของท่าน ไม่ได้ขายเป็นแพ็กเกจ เจ้าของบ้านบางท่านต้องดูตัวเลขก่อน บางท่านมีใบอนุญาตอยู่แล้ว บางท่านเพียงต้องการให้มีคนดูแลงานประจำวันให้ดี เราจะบอกท่านว่าบริการใดเกี่ยวข้องกับท่านจริง",
  menuTitle: "เมนูบริการ",
  menuForWho: "เหมาะกับใคร",
  routeTitle: "เจ้าของบ้านแบบท่านมักเริ่มจากตรงไหน",
  routeBody: "ไม่มีใครใช้ครบทั้งหกบริการ สิ่งที่ท่านต้องการขึ้นอยู่กับว่าบ้านสร้างรายได้อยู่แล้วหรือยัง และมีใบอนุญาตแล้วหรือยัง นี่คือสี่เส้นทางที่เราพบบ่อยที่สุด",
  ...
  step1Meta: "สำหรับบ้านที่ยังไม่มีข้อมูลการเข้าพักให้ดู",
  ...
  step3Meta: "งานประจำวัน ไม่มีระยะผูกมัด",
  step4Name: "งานแม่บ้านและดูแลบำรุงรักษา",
  step4Meta: "สำหรับท่านที่ไม่อยากบริหารผู้ให้บริการเอง",
  step5Name: "ถ่ายภาพภายในบ้าน",
  step5Meta: "ก่อนนำประกาศขึ้นระบบ",
  step6Name: "ออกแบบตกแต่งและปรับปรุงบ้าน",
  step6Meta: "เมื่อบ้านยังทำรายได้ได้ไม่เต็มศักยภาพ",
