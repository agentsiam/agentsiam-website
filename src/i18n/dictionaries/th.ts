...
export const th: Dictionary = {
  ...
  vibeNimman: "คาเฟ่ พื้นที่ทำงานร่วม และย่านออกแบบของเมือง",
  vibeOldCity: "ในเขตคูเมือง วัดวาอาราม และถนนคนเดินวันอาทิตย์",
  vibeSantitham: "ตลาดท้องถิ่น ถนนเงียบกว่า เดินไปนิมมานได้",
  vibeChangKhlan: "ไนท์บาซาร์ ร้านอาหารริมน้ำ ใกล้ทุกอย่าง",
  vibeRiverside: "เลียบแม่น้ำปิง จังหวะช้ากว่า บ้านมีสวน",
  vibeHangDong: "พูลวิลล่า พื้นที่กว้าง และวิวภูเขาทางใต้ของเมือง",
  vibeMaeRim: "รีสอร์ตในหุบเขาและทุ่งนาทางเหนือของเมือง",
  vibeSanSai: "ย่านชานเมือง บ้านสำหรับครอบครัว ใกล้โรงเรียนนานาชาติ",
  formConsent: "การส่งแบบฟอร์มนี้ถือว่าท่านยินยอมให้เราติดต่อกลับเกี่ยวกับเรื่องที่ท่านสอบถาม ดู",
  labelEmail: "อีเมล",
