...
export const th: Dictionary = {
  ...
  underFive: "มีผู้เข้าพักอายุต่ำกว่า 5 ปีหรือไม่", // NEW
  whatThisPlaceIsNot: "สิ่งที่บ้านหลังนี้ไม่ใช่", // NEW
  childSafetyHeading: "เดินทางพร้อมเด็กเล็ก", // NEW
  childSafetyNote:
    "Lotus House เป็นทาวน์เฮ้าส์สามชั้น มีบันไดเชื่อมทุกชั้นและไม่มีประตูกั้น ส่วนดาดฟ้ามีอ่างอาบน้ำแบบตั้งพื้นที่เปิดโล่ง เราไม่ได้ติดตั้งประตูกั้นบันได มีเตียงเด็กให้หากต้องการ เพียงแจ้งเรา บ้านหลังนี้เหมาะกับเด็กโต แต่เราไม่แนะนำสำหรับเด็กวัยหัดเดินหรือผู้ที่ยังขึ้นลงบันไดได้ไม่มั่นคง", // NEW
  childSafetyAck: "ฉันได้อ่านข้อความนี้แล้วและยินดีดำเนินการต่อ", // NEW
};
